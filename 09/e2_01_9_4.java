...
public class e2_01_9_4 {

    public static HashMap<String, String> stringMap = new HashMap<>();

    public static void main(String[] args) throws IOException {

        stringMap.put("hello", "Hello master");
        stringMap.put("weather", "Rainy today");
        stringMap.put("Are you siri?", "No, I'm a stupid bot");
        stringMap.put("Siri, make a call", "I can't");
